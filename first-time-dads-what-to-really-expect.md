...
- Sleeping with epidural and resting up for later is very helpful, although some potential for the baby to experience decel(eration) in vital signs. The water breaking caused more frequent contractions, which further caused the decel, but the Terbutaline shot reduced the contractions, so a C-section was not needed. Phew.
- If a epidural bolus (refresh of the epidural) is requested, it's possible to request a small one. Also possible to start with half of one. This makes it easier to feel and push. Dad block access to epidural IV in case a cranky anesthesiologist tries to give a full bolus without permission, which would delay pushing.
- Progression was stalled after pushing for a few hours. Very tough to curl into shrimp and push while relaxing everything else. Wanted to try cat/cow but didn’t get a chance to (and maybe that would have worsened tearing?). Midwife felt there was extra space was between head and mom’s spine when on back. Almost hit four hour push limit and had to do a C-section, later learned the limit is 6 hours. Super intense amount of energy used and pushing 💪.
...
# Post-partum: congrats! Now it gets hard
...
- Very common (60% of first-borns in U.S.), due to poor advice on how to prepare for after the birth, imo.

### Bottle feeding
- Slow flow wide nipple for jaw development and to reduce nipple confusion. Dr Browns bottle and nipple are good.
- Side position in line.
- Keep bottle tilted down for 30 seconds to avoid bottle preference over breastfeeding. Also, let baby initiate latch on bottle.

I think a post-partum doula, along with parents to help, is very valuable. What would you pay to reduce the 50% divorce rate of new parents? A post-partum doula is very affordable in comparison to all the pain of a divorce.

Now you know a lot more than I did about the tough parts than I did. I don't expect you do everything I say, and you definitely need to customize everything so it works for you. This article is not intended to cover everything you need to know, just the stuff we found most important.
