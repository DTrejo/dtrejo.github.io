...
Named after https://github.com/imgix/motif
*/
...
const generateJPEG = ({ canvas, outputPath }) => {
  outputPath ||= path.join(__dirname, 'output.jpeg')
  ...
  if (DEBUG) {
    out.on('finish', () =>
      console.log(`The image was created successfully at ${outputPath}!`)
    )
  }
}
